<header class="py-4 px-6 sm:px-12 fixed w-full top-0 z-40 bg-white/80 dark:bg-dark-800/80 backdrop-blur-md border-b border-gray-200 dark:border-dark-700 shadow-sm transition-colors duration-300">
  <div class="max-w-6xl mx-auto flex justify-between items-center">
    ...
    <a href="https://github.com/veltophp/velto" target="_blank" class="hidden md:block px-4 py-2 bg-black text-white text-sm font-medium rounded-md shadow hover:bg-gray-900 dark:bg-blue-600 dark:hover:bg-blue-700 transition">
      GitHub <i class="fas fa-external-link-alt ml-1"></i>
    </a>
  </div>
</header>
